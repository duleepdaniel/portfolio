...
const defaultTexts = [ 
  <div className='text-center'><img width={52} src={'https://cdn.svgporn.com/logos/ruby.svg'} alt={'Ruby'} /> Ruby </div>,
  <div className='text-center'><img width={52} src={'https://cdn.svgporn.com/logos/html-5.svg'} alt={'HTML'}/> HTML </div>,
  <div className='text-center'><img width={52} src={'https://cdn.svgporn.com/logos/css-3.svg'} alt={'CSS'}/> CSS </div>,
  <img width={52} src={'https://cdn.svgporn.com/logos/jss.svg'} alt={'JS'}/>,
  <div className='text-center'><img width={52} src={'https://cdn.svgporn.com/logos/heroku-icon.svg'} alt={'Heroku'}/> Heroku </div>,
  <img width={52} src={'https://cdn.svgporn.com/logos/heroku-redis.svg'} alt={'Heroku Redis'}/>,
  <div className='text-center'><img width={52} src={'https://cdn.svgporn.com/logos/kubernetes.svg'} alt={'Kube'}/> Kubernets </div>,
  <div className='text-center'><img width={52} src={'https://cdn.svgporn.com/logos/bootstrap.svg'} alt={'bootstrap'}/> Bootstrap </div>,
  <div className='text-center'><img width={52} src={'https://cdn.svgporn.com/logos/react.svg'} alt={'React'}/> React </div>,
  <img width={90} src={'https://cdn.svgporn.com/logos/rails.svg'} alt={'Rails'}/>,
  <div className='text-center'><img width={52} src={'https://cdn.svgporn.com/logos/capistrano.svg'} alt={'Capistrano'}/> Capistrano </div>,
  <img width={52} src={'https://cdn.svgporn.com/logos/postgresql.svg'} alt={'postgres'}/>,
  <img width={52} src={'https://cdn.svgporn.com/logos/mysql.svg'} alt={'mysql'}/>,
  <img width={52} src={'https://cdn.svgporn.com/logos/sass.svg'} alt={'sass'}/>, 
  <img width={52} src={'https://cdn.svgporn.com/logos/selenium.svg'} alt={'selenium'}/>, 
  <img width={52} src={'https://cdn.svgporn.com/logos/aws.svg'} alt={'AWS'}/>,
  <div className='text-center'><img width={52} src={'https://cdn.svgporn.com/logos/google-cloud.svg'} alt={'GCP'}/>GCP</div>,
  <img width={52} src={'https://cdn.svgporn.com/logos/graphql.svg'} alt={'Graphql'}/>, 
  <img width={52} src={'https://cdn.svgporn.com/logos/redux.svg'} alt={'Redux'}/>, 
  <div className='text-center'><img width={52} src={'https://cdn.svgporn.com/logos/jquery.svg'} alt={'jquery'}/>Jquery </div>,
  <div className='text-center'><img width={52} src={'https://cdn.svgporn.com/logos/bootstrap.svg'} alt={'bootstrap'}/> Bootstrap </div>,
  <img width={52} src={'https://cdn.svgporn.com/logos/postgraphile.svg'} alt={'postgraphql'}/>,
  <img width={52} src={'https://cdn.svgporn.com/logos/nodejs.svg'} alt={'nodejs'}/>
];
